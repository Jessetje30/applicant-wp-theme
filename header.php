...
<section id="header-hero"
         style="background-image: url('<?php echo get_template_directory_uri() ?>/assets/images/bg-hero.png');"
         class="">
    <header>
        <div class="container">
            <div class="account d-none d-xl-block">
            ...
            <nav class="navbar navbar-expand-xl">
                ...
                <div class="wrapper">
                    <button class="navbar-toggler bg-dark hamburger" type="button" data-toggle="collapse"
